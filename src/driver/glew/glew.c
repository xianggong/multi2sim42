...
static char *glew_err_code =
    "\tAn invalid function code was generated by your application in a GLEW "
    "system\n"
...
char *glew_call_name[glew_call_count + 1] = {NULL,
...
static glew_abi_func_t glew_abi_table[glew_call_count + 1] = {NULL,
