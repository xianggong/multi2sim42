...
static char *glu_err_code =
    "\tAn invalid function code was generated by your application in a GLU "
    "system\n"
...
char *glu_call_name[glu_call_count + 1] = {NULL,
...
static glu_abi_func_t glu_abi_table[glu_call_count + 1] = {NULL,
