...
uint32_t evg_opencl_event_get_profiling_info(struct evg_opencl_event_t *event,
                                             uint32_t name, struct mem_t *mem,
...
long long evg_opencl_event_timer(void) { return esim_real_time() * 1000; }
