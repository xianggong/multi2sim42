...
static struct vi_x86_time_dia_window_t *vi_x86_time_dia_window_create(
    struct vi_x86_core_t *core, GtkWidget *parent_toggle_button);
static void vi_x86_time_dia_window_free(
    struct vi_x86_time_dia_window_t *time_dia_window);

static void vi_x86_time_dia_window_destroy(
    GtkWidget *widget, struct vi_x86_time_dia_window_t *time_dia_window) {
  vi_x86_time_dia_window_free(time_dia_window);
}

static gboolean vi_x86_time_dia_window_delete(
...
static struct vi_x86_time_dia_window_t *vi_x86_time_dia_window_create(
  ...
  gtk_container_add(GTK_CONTAINER(window),
                    vi_x86_time_dia_get_widget(time_dia));
...
static void vi_x86_time_dia_window_go_to_cycle(
    struct vi_x86_time_dia_window_t *time_dia_window, long long cycle) {
  vi_x86_time_dia_go_to_cycle(time_dia_window->time_dia, cycle);
}

static void vi_x86_time_dia_window_refresh(
    struct vi_x86_time_dia_window_t *time_dia_window) {
  vi_x86_time_dia_refresh(time_dia_window->time_dia);
}

static GtkWidget *vi_x86_time_dia_window_get_widget(
    struct vi_x86_time_dia_window_t *time_dia_window) {
...
static void vi_x86_core_board_destroy(GtkWidget *widget,
                                      struct vi_x86_core_board_t *board) {
  vi_x86_core_board_free(board);
}

static gboolean vi_x86_core_board_time_dia_toggled(
    GtkWidget *widget, struct vi_x86_core_board_t *board) {
  struct vi_x86_time_dia_window_t *time_dia_window;
  ...
  if (active && !board->time_dia_window) {
    time_dia_window = vi_x86_time_dia_window_create(
        board->core, board->time_dia_toggle_button);
...
static GtkWidget *vi_x86_core_board_get_widget(
    struct vi_x86_core_board_t *board) {
  return board->widget;
}
...
struct vi_x86_panel_t *vi_x86_panel_create(void) {
  ...
  gtk_widget_set_size_request(scrolled_window, VI_X86_CORE_BOARD_WIDTH * 3 / 2,
                              layout_height);
...
void vi_x86_panel_free(struct vi_x86_panel_t *panel) { free(panel); }
