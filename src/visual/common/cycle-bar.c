...
static gboolean vi_cycle_bar_change_value_event(GtkWidget *widget,
...
static gboolean vi_cycle_bar_back_single_clicked_event(GtkWidget *button,
                                                       gpointer data) {
  long long cycle;
...
static gboolean vi_cycle_bar_back_double_clicked_event(GtkWidget *button,
                                                       gpointer data) {
  long long cycle;
...
static gboolean vi_cycle_bar_back_triple_clicked_event(GtkWidget *button,
                                                       gpointer data) {
  long long cycle;
...
static gboolean vi_cycle_bar_forward_single_clicked_event(GtkWidget *button,
                                                          gpointer data) {
  long long cycle;
...
static gboolean vi_cycle_bar_forward_double_clicked_event(GtkWidget *button,
                                                          gpointer data) {
  long long cycle;
...
static gboolean vi_cycle_bar_forward_triple_clicked_event(GtkWidget *button,
                                                          gpointer data) {
  long long cycle;
...
static gboolean vi_cycle_bar_go_to_clicked_event(GtkWidget *button,
                                                 gpointer data) {
  long long cycle;
...
static gboolean cycle_bar_go_to_key_press_event(GtkWidget *entry,
                                                GdkEventKey *event,
                                                gpointer data) {
  long long cycle;

  if (event->type == GDK_KEY_PRESS &&
      (event->keyval == 0xff8d || event->keyval == 0xff0d)) {
    cycle = atoll(gtk_entry_get_text(GTK_ENTRY(vi_cycle_bar->go_to_entry)));
    vi_cycle_bar_go_to_cycle(cycle);
...
void vi_cycle_bar_init(vi_cycle_bar_refresh_func_t refresh_func,
  ...
  m2s_dist_file("forward-single.png", m2s_images_path, m2s_images_path,
                cycle_bar_forward_single_path,
                sizeof cycle_bar_forward_single_path);
  m2s_dist_file("forward-double.png", m2s_images_path, m2s_images_path,
                cycle_bar_forward_double_path,
                sizeof cycle_bar_forward_double_path);
  m2s_dist_file("forward-triple.png", m2s_images_path, m2s_images_path,
                cycle_bar_forward_triple_path,
                sizeof cycle_bar_forward_triple_path);
  m2s_dist_file("go.png", m2s_images_path, m2s_images_path, cycle_bar_go_path,
                sizeof cycle_bar_go_path);
  ...
  g_signal_connect(G_OBJECT(back_single_button), "clicked",
                   G_CALLBACK(vi_cycle_bar_back_single_clicked_event),
                   vi_cycle_bar);
  g_signal_connect(G_OBJECT(back_double_button), "clicked",
                   G_CALLBACK(vi_cycle_bar_back_double_clicked_event),
                   vi_cycle_bar);
  g_signal_connect(G_OBJECT(back_triple_button), "clicked",
                   G_CALLBACK(vi_cycle_bar_back_triple_clicked_event),
                   vi_cycle_bar);
  g_signal_connect(G_OBJECT(forward_single_button), "clicked",
                   G_CALLBACK(vi_cycle_bar_forward_single_clicked_event),
                   vi_cycle_bar);
  g_signal_connect(G_OBJECT(forward_double_button), "clicked",
                   G_CALLBACK(vi_cycle_bar_forward_double_clicked_event),
                   vi_cycle_bar);
  g_signal_connect(G_OBJECT(forward_triple_button), "clicked",
                   G_CALLBACK(vi_cycle_bar_forward_triple_clicked_event),
                   vi_cycle_bar);

  /* Scale */
  long long num_cycles = vi_state_get_num_cycles();
  GtkWidget *scale =
      gtk_scale_new_with_range(GTK_ORIENTATION_HORIZONTAL, 0, num_cycles, 1);
  gtk_widget_set_size_request(scale, 100, 32);
  gtk_scale_set_draw_value(GTK_SCALE(scale), FALSE);
  g_signal_connect(G_OBJECT(scale), "change-value",
                   G_CALLBACK(vi_cycle_bar_change_value_event), vi_cycle_bar);
  vi_cycle_bar->scale = scale;

  /* Images */
  GtkWidget *back_single_image =
      gtk_image_new_from_file(cycle_bar_back_single_path);
  GtkWidget *back_double_image =
      gtk_image_new_from_file(cycle_bar_back_double_path);
  GtkWidget *back_triple_image =
      gtk_image_new_from_file(cycle_bar_back_triple_path);
  GtkWidget *forward_single_image =
      gtk_image_new_from_file(cycle_bar_forward_single_path);
  GtkWidget *forward_double_image =
      gtk_image_new_from_file(cycle_bar_forward_double_path);
  GtkWidget *forward_triple_image =
      gtk_image_new_from_file(cycle_bar_forward_triple_path);
  ...
  gtk_table_attach(GTK_TABLE(navigation_table), back_triple_button, 0, 1, 0, 1,
                   0, 0, 0, 0);
  gtk_table_attach(GTK_TABLE(navigation_table), back_double_button, 1, 2, 0, 1,
                   0, 0, 0, 0);
  gtk_table_attach(GTK_TABLE(navigation_table), back_single_button, 2, 3, 0, 1,
                   0, 0, 0, 0);
  gtk_table_attach(GTK_TABLE(navigation_table), scale, 3, 4, 0, 1,
                   GTK_EXPAND | GTK_FILL, 0, 0, 0);
  gtk_table_attach(GTK_TABLE(navigation_table), forward_single_button, 4, 5, 0,
                   1, 0, 0, 0, 0);
  gtk_table_attach(GTK_TABLE(navigation_table), forward_double_button, 5, 6, 0,
                   1, 0, 0, 0, 0);
  gtk_table_attach(GTK_TABLE(navigation_table), forward_triple_button, 6, 7, 0,
                   1, 0, 0, 0, 0);
  ...
  g_signal_connect(G_OBJECT(go_to_button), "clicked",
                   G_CALLBACK(vi_cycle_bar_go_to_clicked_event), vi_cycle_bar);
  ...
  g_signal_connect(G_OBJECT(go_to_entry), "key-press-event",
                   G_CALLBACK(cycle_bar_go_to_key_press_event), vi_cycle_bar);
  vi_cycle_bar->go_to_entry = go_to_entry;

  /* Table */
  GtkWidget *go_to_table = gtk_table_new(2, 2, FALSE);
  gtk_table_attach(GTK_TABLE(go_to_table), go_to_label, 0, 2, 0, 1,
                   GTK_FILL | GTK_EXPAND, 0, 0, 0);
  gtk_table_attach(GTK_TABLE(go_to_table), go_to_entry, 0, 1, 1, 2, 0, 0, 0, 0);
  gtk_table_attach(GTK_TABLE(go_to_table), go_to_button, 1, 2, 1, 2, 0, 0, 0,
                   0);
...
void vi_cycle_bar_done(void) { free(vi_cycle_bar); }

GtkWidget *vi_cycle_bar_get_widget(void) { return vi_cycle_bar->widget; }
