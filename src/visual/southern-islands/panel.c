...
static void vi_si_time_dia_window_free(
    struct vi_si_time_dia_window_t *time_dia_window);

static void vi_si_time_dia_window_destroy(
    GtkWidget *widget, struct vi_si_time_dia_window_t *time_dia_window) {
  vi_si_time_dia_window_free(time_dia_window);
}

static gboolean vi_si_time_dia_window_delete(
...
static void vi_si_time_dia_window_go_to_cycle(
    struct vi_si_time_dia_window_t *time_dia_window, long long cycle) {
  vi_si_time_dia_go_to_cycle(time_dia_window->time_dia, cycle);
}

static void vi_si_time_dia_window_refresh(
    struct vi_si_time_dia_window_t *time_dia_window) {
  vi_si_time_dia_refresh(time_dia_window->time_dia);
}

static GtkWidget *vi_si_time_dia_window_get_widget(
    struct vi_si_time_dia_window_t *time_dia_window) {
...
static gboolean vi_cu_board_time_dia_toggled(GtkWidget *widget,
  ...
  if (active && !board->time_dia_window) {
    time_dia_window = vi_si_time_dia_window_create(
  ...
  if (!active && board->time_dia_window) {
    gtk_widget_destroy(
        vi_si_time_dia_window_get_widget(board->time_dia_window));
...
void vi_si_panel_free(struct vi_si_panel_t *panel) { free(panel); }
