...
#define mips_isa_call_debug(...) \
  debug(mips_isa_call_debug_category, __VA_ARGS__)
#define mips_isa_inst_debug(...) \
  debug(mips_isa_inst_debug_category, __VA_ARGS__)
...
void mips_gpr_set_value(struct mips_ctx_t *ctx, unsigned int reg_no,
                        unsigned int value);
