...
char *mips_err_note =
    ...
    "\tIf you encounter an unimplemented instruction, please send an  email "
    "to\n"
...
void mips_isa_BEQ_impl(struct mips_ctx_t *ctx) {
  ...
  mips_isa_inst_debug("  regRS = %d and regRT = %d",
                      mips_gpr_get_value(ctx, RS), mips_gpr_get_value(ctx, RT));
}
...
void mips_isa_ADDIU_impl(struct mips_ctx_t *ctx) {
  mips_gpr_set_value(ctx, RT,
                     mips_gpr_get_value(ctx, RS) + SEXT32((signed)IMM, 16));
...
void mips_isa_ORI_impl(struct mips_ctx_t *ctx) {
  mips_gpr_set_value(ctx, RT, mips_gpr_get_value(ctx, RS) |
                                  ((unsigned int)(IMM) & ((1U << (16)) - 1)));
  // (unsigned int) IMM);
...
void mips_isa_BEQL_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BNEL_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BLEZL_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BGTZL_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_LWL_impl(struct mips_ctx_t *ctx) {
  ...
  for (i = 0; i < size; i++) dst[3 - i] = src[i];
}
...
void mips_isa_SWL_impl(struct mips_ctx_t *ctx) {
  ...
  int size = 4 - (addr & 3);
  int i;
  for (i = 0; i < size; i++) dst[i] = src[3 - i];
...
void mips_isa_CACHE_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }

void mips_isa_LL_impl(struct mips_ctx_t *ctx) {
  unsigned int temp;
  mem_read(ctx->mem, mips_gpr_get_value(ctx, RS) + IMM, sizeof(unsigned int),
           &temp);
  mips_gpr_set_value(ctx, RT, temp);
...
void mips_isa_LWC2_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_PREF_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_LDC2_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_SWC1_impl(struct mips_ctx_t *ctx) {
  ...
  mem_write(ctx->mem, mips_gpr_get_value(ctx, RS) + IMM, sizeof(unsigned int),
            &temp);
}
void mips_isa_SWC2_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_SDC2_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_SLL_impl(struct mips_ctx_t *ctx) {
  ...
  mips_isa_inst_debug("  %x=%x<<%x", mips_gpr_get_value(ctx, RD),
                      mips_gpr_get_value(ctx, RT), SA);
}
void mips_isa_MOVF_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MOVT_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_SRL_impl(struct mips_ctx_t *ctx) {
  mips_gpr_set_value(ctx, RD, mips_gpr_get_value(ctx, RT) >> SA);
}
void mips_isa_ROR_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_ROTRV_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_JALR_impl(struct mips_ctx_t *ctx) {
  ...
  mips_isa_inst_debug("  reg %d = pc + 8 = %x", RD,
                      mips_gpr_get_value(ctx, RD));
}
...
void mips_isa_SYSCALL_impl(struct mips_ctx_t *ctx) { mips_sys_call(ctx); }
void mips_isa_BREAK_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_MTHI_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_MULT_impl(struct mips_ctx_t *ctx) {
  unsigned long long int temp =
      (long long int)mips_gpr_get_value(ctx, (int)RS) *
...
void mips_isa_MULTU_impl(struct mips_ctx_t *ctx) {
  unsigned long long int temp =
      (unsigned long long int)(mips_gpr_get_value(ctx, RS)) *
      (unsigned long long int)(mips_gpr_get_value(ctx, RT));
  ctx->regs->regs_LO = BITS64(temp, 31, 0);
  ctx->regs->regs_HI = BITS64(temp, 63, 32);
  mips_isa_inst_debug(" r%d=%x, r%d=%x, prod=%llu\n", RS,
                      mips_gpr_get_value(ctx, RS), RT,
                      mips_gpr_get_value(ctx, RT), temp);
...
void mips_isa_DIV_impl(struct mips_ctx_t *ctx) {
  if (mips_gpr_get_value(ctx, RT)) {
    ctx->regs->regs_LO =
        (int)mips_gpr_get_value(ctx, RS) / (int)mips_gpr_get_value(ctx, RT);
    ctx->regs->regs_HI =
        (int)mips_gpr_get_value(ctx, RS) % (int)mips_gpr_get_value(ctx, RT);
  }
}
...
void mips_isa_ADDU_impl(struct mips_ctx_t *ctx) {
  mips_gpr_set_value(ctx, RD,
                     mips_gpr_get_value(ctx, RS) + mips_gpr_get_value(ctx, RT));
  mips_isa_inst_debug("  %x = %x + %x", mips_gpr_get_value(ctx, RD),
                      mips_gpr_get_value(ctx, RS), mips_gpr_get_value(ctx, RT));
}
void mips_isa_SUB_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_TGE_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TGEU_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TLT_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TLTU_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TEQ_impl(struct mips_ctx_t *ctx) {
  if ((int)mips_gpr_get_value(ctx, RS) == (int)mips_gpr_get_value(ctx, RT)) {
    // FIXME:	TRAP, this is supposed to trap
  }
}
void mips_isa_TNE_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_BLTZ_impl(struct mips_ctx_t *ctx) {
  if ((int)mips_gpr_get_value(ctx, RS) < 0) mips_isa_rel_branch(ctx, IMM << 2);
}
void mips_isa_BGEZ_impl(struct mips_ctx_t *ctx) {
  if ((int)mips_gpr_get_value(ctx, RS) >= 0)
    mips_isa_rel_branch(ctx, SEXT32(IMM << 2, 16));
}
void mips_isa_BLTZL_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BGEZL_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TGEI_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TGEIU_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TLTI_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TLTIU_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TEQI_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TNEI_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BLTZAL_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BGEZAL_impl(struct mips_ctx_t *ctx) {
  mips_gpr_set_value(ctx, 31, ctx->regs->pc + 8);
  if ((int)mips_gpr_get_value(ctx, RS) >= 0)
    mips_isa_rel_branch(ctx, SEXT32(IMM, 16) << 2);
  mips_isa_inst_debug("  BGEZAL: PC=%8x, r31=%8x", ctx->regs->pc,
                      ctx->regs->regs_R[31]);
}
void mips_isa_BLTZALL_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BGEZALL_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_SYNCI_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_MADDU_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_MSUBU_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_CLZ_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_CLO_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_EXT_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }

//#define MASK_BITS(X, HI, LO) (unsigned int)((X) & ((((1ull)<<(HI-LO+1))-1) <<
//LO))
void mips_isa_INS_impl(struct mips_ctx_t *ctx) {
  if (SA > RD) mips_isa_inst_debug(" INS: LSB>MSB, unpredictable behavior\n");
  unsigned int value, new_rt;
  value =
      BITS32(mips_gpr_get_value(ctx, RS),
             (mips_gpr_get_value(ctx, RD) - mips_gpr_get_value(ctx, SA)), 0);
  new_rt = SET_BITS_32(mips_gpr_get_value(ctx, RT), mips_gpr_get_value(ctx, RD),
                       mips_gpr_get_value(ctx, SA), value);
  mips_gpr_set_value(ctx, RT, new_rt);
  mips_isa_inst_debug(" r%d=$0x%x", RT, mips_gpr_get_value(ctx, RT));
  //__MIPS_NOT_IMPL__
}
void mips_isa_WSBH_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_SEB_impl(struct mips_ctx_t *ctx) {
  mips_gpr_set_value(ctx, RD,
                     SEXT32(BITS32(mips_gpr_get_value(ctx, RT), 7, 0), 16));
}
void mips_isa_SEH_impl(struct mips_ctx_t *ctx) {
  mips_gpr_set_value(
      ctx, RD, SEXT32((unsigned short int)mips_gpr_get_value(ctx, RT), 16));
}
...
void mips_isa_MFCO_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MTCO_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_RDPGPR_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_DI_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_EI_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_WRPGPR_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TLBR_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TLBWI_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TLBWR_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TLBP_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_ERET_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_DERET_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_WAIT_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_MFHC1_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_MTHC1_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BC1F_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BC1FL_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BC1T_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BC1TL_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_ABS_S_impl(struct mips_ctx_t *ctx) {
  float temp =
      MIPS_FPR_S_GET(FS) < 0.0 ? -MIPS_FPR_S_GET(FS) : MIPS_FPR_S_GET(FS);
  MIPS_FPR_S_SET(FD, temp);
}
...
void mips_isa_ROUND_L_S_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TRUNC_L_S_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_CEIL_L_S_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_FLOOR_L_S_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_ROUND_W_S_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TRUNC_W_S_impl(struct mips_ctx_t *ctx) {
  float temp = MIPS_FPR_S_GET(FS);
  int itmp = (int)temp;
  MIPS_FPR_S_SET(FD, *(float *)&itmp);
}
void mips_isa_CEIL_W_S_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_FLOOR_W_S_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MOVF_S_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MOVT_S_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MOVZ_S_impl(struct mips_ctx_t *ctx) {
  if (!mips_gpr_get_value(ctx, RT)) MIPS_FPR_S_SET(FD, MIPS_FPR_S_GET(FS));
}
void mips_isa_MOVN_S_impl(struct mips_ctx_t *ctx) {
  if (mips_gpr_get_value(ctx, RT)) MIPS_FPR_S_SET(FD, MIPS_FPR_S_GET(FS));
}
void mips_isa_RECIP_S_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_RSQRT_S_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_CVT_PS_S_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_ABS_D_impl(struct mips_ctx_t *ctx) {
  double temp =
      MIPS_FPR_D_GET(FS) < 0.0 ? -MIPS_FPR_D_GET(FS) : MIPS_FPR_D_GET(FS);
  MIPS_FPR_D_SET(FD, temp);
}
...
void mips_isa_ROUND_L_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TRUNC_L_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_CEIL_L_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_FLOOR_L_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_ROUND_W_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_TRUNC_W_D_impl(struct mips_ctx_t *ctx) {
  double temp = MIPS_FPR_D_GET(FS);
  int itmp = (int)temp;
  MIPS_FPR_D_SET(FD, *(double *)&itmp);
}
void mips_isa_CEIL_W_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_FLOOR_W_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MOVF_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MOVT_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MOVZ_D_impl(struct mips_ctx_t *ctx) {
  if (!mips_gpr_get_value(ctx, RT)) MIPS_FPR_D_SET(FD, MIPS_FPR_D_GET(FS));
}
void mips_isa_MOVN_D_impl(struct mips_ctx_t *ctx) {
  if (mips_gpr_get_value(ctx, RT)) MIPS_FPR_D_SET(FD, MIPS_FPR_D_GET(FS));
}
void mips_isa_RECIP_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_RSQRT_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_C_F_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_UN_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_EQ_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_UEQ_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_OLT_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_ULT_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_OLE_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_ULE_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_SF_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_NGLE_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_SEQ_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_NGL_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_LT_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_NGE_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_LE_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_C_NGT_D_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
...
void mips_isa_ADD_PS_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_SUB_PS_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MUL_PS_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_ABS_PS_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MOV_PS_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_NEG_PS_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MOVF_PS_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MOVT_PS_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MOVZ_PS_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MOVN_PS_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_CVT_S_PU_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_CVT_S_PL_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_PLL_PS_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_PLU_PS_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_PUL_PS_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_PUU_PS_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }

/* Instructions with opcode COP2=0x12 arg2 is the rs field (bits
 * [25:21]) arg3, is used for the bits nd and tf (17 and 16) */

void mips_isa_MFC2_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_CFC2_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MFHC2_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MTC2_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_CTC2_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_MTHC2_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BC2F_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BC2FL_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BC2T_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_BC2TL_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
void mips_isa_COP2_impl(struct mips_ctx_t *ctx) { __MIPS_NOT_IMPL__ }
