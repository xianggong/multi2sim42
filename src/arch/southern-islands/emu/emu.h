...
#define SI_EMU_UAV_TABLE_SIZE \
  (SI_EMU_MAX_NUM_UAVS * SI_EMU_UAV_TABLE_ENTRY_SIZE)

/* Vertex buffer table */
#define SI_EMU_MAX_NUM_VERTEX_BUFFERS 16
#define SI_EMU_VERTEX_BUFFER_TABLE_ENTRY_SIZE 32
#define SI_EMU_VERTEX_BUFFER_TABLE_SIZE \
  (SI_EMU_MAX_NUM_VERTEX_BUFFERS * SI_EMU_VERTEX_BUFFER_TABLE_ENTRY_SIZE)

/* Constant buffer table */
#define SI_EMU_MAX_NUM_CONST_BUFS 16
#define SI_EMU_CONST_BUF_TABLE_ENTRY_SIZE 16
#define SI_EMU_CONST_BUF_TABLE_SIZE \
  (SI_EMU_MAX_NUM_CONST_BUFS * SI_EMU_CONST_BUF_TABLE_ENTRY_SIZE)

/* Resource table */
#define SI_EMU_MAX_NUM_RESOURCES 16
#define SI_EMU_RESOURCE_TABLE_ENTRY_SIZE 32
#define SI_EMU_RESOURCE_TABLE_SIZE \
  (SI_EMU_MAX_NUM_RESOURCES * SI_EMU_RESOURCE_TABLE_ENTRY_SIZE)

#define SI_EMU_TOTAL_TABLE_SIZE                          \
  (SI_EMU_UAV_TABLE_SIZE + SI_EMU_CONST_BUF_TABLE_SIZE + \
   SI_EMU_RESOURCE_TABLE_SIZE + SI_EMU_VERTEX_BUFFER_TABLE_SIZE)

/* Constant buffers */
#define SI_EMU_CONST_BUF_0_SIZE 160  /* Defined in Metadata.pdf */
#define SI_EMU_CONST_BUF_1_SIZE 1024 /* FIXME */

#define SI_EMU_TOTAL_CONST_BUF_SIZE \
  (SI_EMU_CONST_BUF_0_SIZE + SI_EMU_CONST_BUF_1_SIZE)
