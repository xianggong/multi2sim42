...
void si_cu_spatial_report_dump(struct si_compute_unit_t *compute_unit) {
  ...
  fprintf(f,
          "CU,%d,MemAcc,%lld,MappedWGs,%lld,UnmappedWGs,%lld,ALUIssued,%lld,"
          "LDSIssued,%lld,Cycles,%lld\n",
          compute_unit->id, compute_unit->vector_mem_unit.inflight_mem_accesses,
          compute_unit->interval_mapped_work_groups,
          compute_unit->interval_unmapped_work_groups,
          compute_unit->interval_alu_issued, compute_unit->interval_lds_issued,
...
void si_report_global_mem_inflight(struct si_compute_unit_t *compute_unit,
...
void si_report_global_mem_finish(struct si_compute_unit_t *compute_unit,
