...
struct str_map_t kpl_inst_sat_map = {2, {{"", 0}, {".SAT", 1}}};

struct str_map_t kpl_inst_x_map = {2, {{"", 0}, {".X", 1}}};

struct str_map_t kpl_inst_cc_map = {2, {{"", 0}, {".CC", 1}}};

struct str_map_t kpl_inst_hi_map = {2, {{"", 0}, {".HI", 1}}};

struct str_map_t kpl_inst_u0_map = {
    4, {{".U32.U32", 0}, {".S32.U32", 1}, {".U32.S32", 2}, {"", 3}}};

struct str_map_t kpl_inst_keeprefcount_map = {2,
                                              {{"", 0}, {".KEEPREFCOUNT", 1}}};

struct str_map_t kpl_inst_s_map = {2, {{"", 0}, {".S", 1}}};

struct str_map_t kpl_inst_and_map = {
    4, {{".AND", 0}, {".OR", 1}, {".XOR", 2}, {".INVALIDBOP3", 3}}};
...
struct str_map_t kpl_inst_po_map = {2, {{"", 0}, {".PO", 1}}};

struct str_map_t kpl_inst_u1_map = {2, {{".U32.U32", 0}, {".U32.S32", 1}}};

struct str_map_t kpl_inst_f_map = {8,
                                   {{".F", 0},
                                    {".LT", 1},
                                    {".EQ", 2},
                                    {".LE", 3},
...
struct str_map_t kpl_inst_u_map = {2, {{"", 0}, {".U", 1}}};

struct str_map_t kpl_inst_lmt_map = {2, {{"", 0}, {".LMT", 1}}};

struct str_map_t kpl_inst_e_map = {2, {{"", 0}, {".E", 1}}};

struct str_map_t kpl_inst_u32_map = {2, {{"", 0}, {".U32", 1}}};

struct str_map_t kpl_inst_rm_map = {
    4, {{"", 0}, {".RM", 1}, {".RP", 2}, {".RZ", 3}}};

struct str_map_t kpl_inst_us_map = {2,
                                    {
                                     {".U32", 0}, {".S32", 1},
                                    }};
...
void kpl_asm_init(void) {
  ...
  kpl_asm_table_c_e_c[KPL_OPCODE_C_E_C_A].next_table = kpl_asm_table_c_e_c_a;
  kpl_asm_table_c_e_c[KPL_OPCODE_C_E_C_A].next_table_low = 58;
  kpl_asm_table_c_e_c[KPL_OPCODE_C_E_C_A].next_table_high = 58;

  kpl_asm_table_c_e_c[KPL_OPCODE_C_E_C_B].next_table = kpl_asm_table_c_e_c_b;
...
#define DEFINST(_name, _fmt_str, ...)                                          \
  kpl_asm_table_init(KPL_INST_##_name, #_name, _fmt_str, PP_NARG(__VA_ARGS__), \
                     __VA_ARGS__);
