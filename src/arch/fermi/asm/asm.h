...
#define DEFINST(_name, _fmt_str, _fmt, _category, _opcode) FRM_FMT_##_fmt,
#include "asm.dat"
#undef DEFINST
...
#define DEFINST(_name, _fmt_str, _fmt, _category, _opcode) FRM_INST_##_name,
#include "asm.dat"
#undef DEFINST
...
void frm_inst_get_op_src(struct frm_inst_t *inst, int src_idx, int *sel,
