...
struct frm_thread_t;
int frm_reg_file_rename(struct frm_sm_t *sm, struct frm_thread_t *thread,
                        int logical_register);
void frm_reg_file_inverse_rename(struct frm_sm_t *sm, int physical_register,
...
void frm_warp_inst_queue_map_warps(
    ...
    struct frm_thread_block_t *thread_block);
void frm_warp_inst_queue_unmap_warps(
    struct frm_warp_inst_queue_t *warp_inst_queue,
    struct frm_thread_block_t *thread_block);
