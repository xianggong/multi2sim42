...
struct frm_thread_t {
   ...
   * At the end, threads with different 'branch_digest' numbers can be
   * considered
   * divergent threads. */
  ...
  int lds_access_count; /* Number of local memory access performed by last
                           instruction */
