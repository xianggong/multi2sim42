...
#define op_xxx_rm8_1_impl(xxx, idep)                                       \
  void x86_isa_##xxx##_rm8_1_impl(X86Context *ctx) {                       \
    ...
    regs->eflags = flags;                                                  \
    x86_uinst_new(ctx, x86_uinst_shift, idep, x86_dep_rm8, 0, x86_dep_rm8, \
...
#define op_xxx_rm8_cl_impl(xxx, idep)                                   \
  void x86_isa_##xxx##_rm8_cl_impl(X86Context *ctx) {                   \
    ...
    X86ContextStoreRm8(ctx, rm8);                                       \
    regs->eflags = flags;                                               \
    x86_uinst_new(ctx, x86_uinst_shift, idep, x86_dep_rm8, x86_dep_ecx, \
                  x86_dep_rm8, x86_dep_cf, x86_dep_of, 0);              \
  }
...
#define op_xxx_rm16_1_impl(xxx, idep)                                        \
  void x86_isa_##xxx##_rm16_1_impl(X86Context *ctx) {                        \
    ...
    regs->eflags = flags;                                                    \
    x86_uinst_new(ctx, x86_uinst_shift, idep, x86_dep_rm16, 0, x86_dep_rm16, \
                  x86_dep_cf, x86_dep_of, 0);                                \
  }
...
#define op_xxx_rm16_cl_impl(xxx, idep)                                   \
  void x86_isa_##xxx##_rm16_cl_impl(X86Context *ctx) {                   \
    ...
    X86ContextStoreRm16(ctx, rm16);                                      \
    regs->eflags = flags;                                                \
    x86_uinst_new(ctx, x86_uinst_shift, idep, x86_dep_rm16, x86_dep_ecx, \
                  x86_dep_rm16, x86_dep_cf, x86_dep_of, 0);              \
  }
...
#define op_xxx_rm32_1_impl(xxx, idep)                                        \
  void x86_isa_##xxx##_rm32_1_impl(X86Context *ctx) {                        \
    ...
    regs->eflags = flags;                                                    \
    x86_uinst_new(ctx, x86_uinst_shift, idep, x86_dep_rm32, 0, x86_dep_rm32, \
                  x86_dep_cf, x86_dep_of, 0);                                \
  }
...
#define op_xxx_rm32_cl_impl(xxx, idep)                                   \
  void x86_isa_##xxx##_rm32_cl_impl(X86Context *ctx) {                   \
    ...
    X86ContextStoreRm32(ctx, rm32);                                      \
    regs->eflags = flags;                                                \
    x86_uinst_new(ctx, x86_uinst_shift, idep, x86_dep_rm32, x86_dep_ecx, \
                  x86_dep_rm32, x86_dep_cf, x86_dep_of, 0);              \
  }
...
#define op_xxx_all(xxx, idep)                                              \
  op_xxx_rm8_1_impl(xxx, idep) op_xxx_rm8_cl_impl(xxx, idep)               \
      op_xxx_rm8_imm8_impl(xxx, idep) op_xxx_rm16_1_impl(xxx, idep)        \
          op_xxx_rm16_cl_impl(xxx, idep) op_xxx_rm16_imm8_impl(xxx, idep)  \
              op_xxx_rm32_1_impl(xxx, idep) op_xxx_rm32_cl_impl(xxx, idep) \
                  op_xxx_rm32_imm8_impl(xxx, idep)

/* Implementation for rotation and shift instructions */
op_xxx_all(rcl, x86_dep_cf) op_xxx_all(rcr, x86_dep_cf) op_xxx_all(rol, 0)
    op_xxx_all(ror, 0)

        op_xxx_all(sar, 0) op_xxx_all(shl, 0) op_xxx_all(shr, 0)
