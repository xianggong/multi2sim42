...
void x86_isa_bsf_r32_rm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_shift, x86_dep_rm32, 0, 0, x86_dep_r32,
                x86_dep_zps, 0, 0);
}
...
void x86_isa_bswap_ir32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_shift, x86_dep_ir32, 0, 0, x86_dep_ir32, 0, 0,
                0);
}
...
void x86_isa_bt_rm32_r32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_shift, x86_dep_rm32, x86_dep_r32, 0, x86_dep_cf,
                0, 0, 0);
}
...
void x86_isa_bts_rm32_imm8_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_shift, x86_dep_rm32, 0, 0, x86_dep_rm32,
                x86_dep_cf, 0, 0);
}
...
void x86_isa_call_rel32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_effaddr, x86_dep_esp, 0, 0, x86_dep_aux, 0, 0,
                0);
  x86_uinst_new_mem(ctx, x86_uinst_store, regs->esp, 4, x86_dep_aux, 0, 0, 0, 0,
                    0, 0);
...
void x86_isa_cmpxchg_rm32_r32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_sub, x86_dep_eax, x86_dep_rm32, 0, x86_dep_zps,
                x86_dep_cf, x86_dep_of, 0);
  x86_uinst_new(ctx, x86_uinst_move, x86_dep_zps, x86_dep_r32, 0, x86_dep_rm32,
                0, 0, 0);
  x86_uinst_new(ctx, x86_uinst_move, x86_dep_cf, x86_dep_rm32, 0, x86_dep_eax,
                0, 0, 0);
}
...
void x86_isa_cmpxchg8b_m64_impl(X86Context *ctx) {
  ...
  x86_uinst_new_mem(ctx, x86_uinst_load, X86ContextEffectiveAddress(ctx), 8, 0,
                    0, 0, x86_dep_aux, 0, 0, 0); /* Load m64 */
  x86_uinst_new(ctx, x86_uinst_sub, x86_dep_edx, x86_dep_eax, x86_dep_aux,
                x86_dep_zps, 0, 0, 0); /* Compare edx-eax with m64 */
  x86_uinst_new_mem(ctx, x86_uinst_store, X86ContextEffectiveAddress(ctx), 8,
                    x86_dep_zps, x86_dep_ecx, x86_dep_ebx, x86_dep_mem64, 0, 0,
                    0); /* Conditionally store m64 */
  x86_uinst_new(ctx, x86_uinst_move, x86_dep_zps, 0, 0, x86_dep_edx,
                x86_dep_eax, 0, 0); /* Conditionaly store edx-eax */
}
...
void x86_isa_cpuid_impl(X86Context *ctx) {
  ...
  switch (regs->eax) {
    ...
    case 0x1:
      ...
      info = SETBITVALUE32(info, 22,
                           1); /* ACPI - Thermal Monitor and Clock Ctrl */
      ...
      info = SETBITVALUE32(info, 15,
                           1); /* CMOV - Conditional Move/Compare Instruction */
      info = SETBITVALUE32(info, 14, 1); /* MCA - Machine Check Architecture */
      info = SETBITVALUE32(info, 13, 1); /* PGE - PTE Global bit */
      info =
          SETBITVALUE32(info, 12, 1); /* MTRR - Memory Type Range Registers */
      ...
      info =
          SETBITVALUE32(info, 1, 1); /* VME - Virtual-8086 Mode Enhancement */
    ...
    default:
      ...
      X86ContextError(ctx, "inst 'cpuid' not implemented for eax=0x%x",
                      regs->eax);
  }
...
void x86_isa_dec_rm8_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_sub, x86_dep_rm8, 0, 0, x86_dep_rm8, x86_dep_zps,
                x86_dep_of, 0);
}
...
void x86_isa_dec_rm16_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_sub, x86_dep_rm16, 0, 0, x86_dep_rm16,
                x86_dep_zps, x86_dep_of, 0);
}
...
void x86_isa_dec_rm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_sub, x86_dep_rm32, 0, 0, x86_dep_rm32,
                x86_dep_zps, x86_dep_of, 0);
}
...
void x86_isa_dec_ir16_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_sub, x86_dep_ir16, 0, 0, x86_dep_ir16,
                x86_dep_zps, x86_dep_of, 0);
}
...
void x86_isa_dec_ir32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_sub, x86_dep_ir32, 0, 0, x86_dep_ir32,
                x86_dep_zps, x86_dep_of, 0);
}
...
void x86_isa_div_rm8_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_div, x86_dep_eax, x86_dep_rm8, 0, x86_dep_eax, 0,
                0, 0);
}
...
void x86_isa_div_rm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_div, x86_dep_edx, x86_dep_eax, x86_dep_rm32,
...
void x86_isa_idiv_rm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_div, x86_dep_rm32, x86_dep_eax, 0, x86_dep_eax,
                x86_dep_edx, 0, 0);
}
...
void x86_isa_imul_rm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_mult, x86_dep_rm32, x86_dep_eax, 0, x86_dep_eax,
                x86_dep_edx, x86_dep_cf, x86_dep_of);
}
...
void x86_isa_imul_r32_rm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_mult, x86_dep_r32, x86_dep_rm32, 0, x86_dep_r32,
                0, x86_dep_cf, x86_dep_of);
}
...
void x86_isa_imul_r32_rm32_imm8_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_mult, x86_dep_rm32, 0, 0, x86_dep_r32, 0,
                x86_dep_cf, x86_dep_of);
}
...
void x86_isa_inc_rm8_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_add, x86_dep_rm8, 0, 0, x86_dep_rm8, 0,
                x86_dep_zps, x86_dep_of);
}
...
void x86_isa_inc_rm16_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_add, x86_dep_rm16, 0, 0, x86_dep_rm16, 0,
                x86_dep_zps, x86_dep_of);
}
...
void x86_isa_inc_rm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_add, x86_dep_rm32, 0, 0, x86_dep_rm32, 0,
                x86_dep_zps, x86_dep_of);
}
...
void x86_isa_inc_ir16_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_add, x86_dep_ir16, 0, 0, x86_dep_ir16, 0,
                x86_dep_zps, x86_dep_of);
}
...
void x86_isa_inc_ir32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_add, x86_dep_ir32, 0, 0, x86_dep_ir32, 0,
                x86_dep_zps, x86_dep_of);
}
...
void x86_isa_int_imm8_impl(X86Context *ctx) {
  ...
  spec_mode = X86ContextGetState(ctx, X86ContextSpecMode);
  if (!spec_mode) X86ContextSyscall(ctx);
...
void x86_isa_lea_r32_m_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_effaddr, x86_dep_easeg, x86_dep_eabas,
                x86_dep_eaidx, x86_dep_r32, 0, 0, 0);
}
...
void x86_isa_leave_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_effaddr, x86_dep_esp, 0, 0, x86_dep_aux, 0, 0,
                0);
  x86_uinst_new_mem(ctx, x86_uinst_load, regs->esp - 4, 4, x86_dep_aux, 0, 0,
                    x86_dep_ebp, 0, 0, 0);
...
void x86_isa_mov_al_moffs8_impl(X86Context *ctx) {
  ...
  x86_uinst_new_mem(ctx, x86_uinst_load, X86ContextMoffsAddress(ctx), 1,
                    x86_dep_aux, 0, 0, x86_dep_eax, 0, 0, 0);
}
...
void x86_isa_mov_ax_moffs16_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_effaddr, 0, 0, 0, x86_dep_aux, 0, 0, 0);
  x86_uinst_new_mem(ctx, x86_uinst_load, X86ContextMoffsAddress(ctx), 2,
                    x86_dep_aux, 0, 0, x86_dep_eax, 0, 0, 0);
}
...
void x86_isa_mov_eax_moffs32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_effaddr, 0, 0, 0, x86_dep_aux, 0, 0, 0);
  x86_uinst_new_mem(ctx, x86_uinst_load, X86ContextMoffsAddress(ctx), 4,
                    x86_dep_aux, 0, 0, x86_dep_eax, 0, 0, 0);
}
...
void x86_isa_mov_moffs8_al_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_effaddr, 0, 0, 0, x86_dep_aux, 0, 0, 0);
  x86_uinst_new_mem(ctx, x86_uinst_store, X86ContextMoffsAddress(ctx), 1,
                    x86_dep_aux, x86_dep_eax, 0, 0, 0, 0, 0);
}
...
void x86_isa_mov_moffs16_ax_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_effaddr, 0, 0, 0, x86_dep_aux, 0, 0, 0);
  x86_uinst_new_mem(ctx, x86_uinst_store, X86ContextMoffsAddress(ctx), 2,
                    x86_dep_aux, x86_dep_eax, 0, 0, 0, 0, 0);
}
...
void x86_isa_mov_moffs32_eax_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_effaddr, 0, 0, 0, x86_dep_aux, 0, 0, 0);
  x86_uinst_new_mem(ctx, x86_uinst_store, X86ContextMoffsAddress(ctx), 4,
                    x86_dep_aux, x86_dep_eax, 0, 0, 0, 0, 0);
}
...
void x86_isa_mul_rm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_mult, x86_dep_rm32, x86_dep_eax, 0, x86_dep_edx,
                x86_dep_eax, x86_dep_of, x86_dep_cf);
}
...
void x86_isa_neg_rm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_sub, x86_dep_rm32, 0, 0, x86_dep_rm32,
                x86_dep_zps, x86_dep_cf, x86_dep_of);
}
...
void x86_isa_popf_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_effaddr, x86_dep_esp, 0, 0, x86_dep_aux, 0, 0,
                0);
  x86_uinst_new_mem(ctx, x86_uinst_load, regs->esp - 4, 4, x86_dep_aux, 0, 0,
                    x86_dep_zps, x86_dep_cf, x86_dep_of, 0);
  x86_uinst_new(ctx, x86_uinst_add, x86_dep_esp, 0, 0, x86_dep_esp, 0, 0, 0);
}
...
void x86_isa_prefetcht0_m8_impl(X86Context *ctx) {
  ...
  if (arch_x86->sim_kind != arch_sim_kind_detailed) return;

  if (!x86_emu_process_prefetch_hints) return;

  eff_addr = X86ContextEffectiveAddress(ctx);
  x86_uinst_new(ctx, x86_uinst_effaddr, x86_dep_easeg, x86_dep_eabas,
                x86_dep_eaidx, x86_dep_aux, 0, 0, 0);
  x86_uinst_new_mem(ctx, x86_uinst_prefetch, eff_addr, 1, x86_dep_aux, 0, 0, 0,
                    0, 0, 0);
}
...
void x86_isa_push_rm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_effaddr, x86_dep_esp, 0, 0, x86_dep_aux, 0, 0,
                0);
  x86_uinst_new_mem(ctx, x86_uinst_store, regs->esp, 4, x86_dep_aux,
                    x86_dep_rm32, 0, 0, 0, 0, 0);
}
...
void x86_isa_pushf_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_effaddr, x86_dep_esp, 0, 0, x86_dep_aux, 0, 0,
                0);
  x86_uinst_new(ctx, x86_uinst_move, x86_dep_zps, x86_dep_cf, x86_dep_of,
                x86_dep_aux2, 0, 0, 0);
  x86_uinst_new_mem(ctx, x86_uinst_store, regs->esp, 4, x86_dep_aux,
                    x86_dep_aux2, 0, 0, 0, 0, 0);
}
...
void x86_isa_ret_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_effaddr, x86_dep_esp, 0, 0, x86_dep_aux, 0, 0,
                0);
  x86_uinst_new_mem(ctx, x86_uinst_load, regs->esp - 4, 4, x86_dep_aux, 0, 0,
                    x86_dep_aux, 0, 0, 0); /* pop aux */
  x86_uinst_new(ctx, x86_uinst_add, x86_dep_esp, 0, 0, x86_dep_esp, 0, 0,
                0); /* add esp, 4 */
  x86_uinst_new(ctx, x86_uinst_ret, x86_dep_aux, 0, 0, 0, 0, 0,
                0); /* jmp aux */
}

void x86_isa_repz_ret_impl(X86Context *ctx) { x86_isa_ret_impl(ctx); }
...
void x86_isa_ret_imm16_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_effaddr, x86_dep_esp, 0, 0, x86_dep_aux, 0, 0,
                0);
  x86_uinst_new_mem(ctx, x86_uinst_load, regs->esp - 4 - pop, 4, x86_dep_aux, 0,
                    0, x86_dep_aux, 0, 0, 0); /* pop aux */
  x86_uinst_new(ctx, x86_uinst_add, x86_dep_esp, 0, 0, x86_dep_esp, 0, 0,
                0); /* add esp, 4 */
  x86_uinst_new(ctx, x86_uinst_ret, x86_dep_aux, 0, 0, 0, 0, 0,
                0); /* jmp aux */
...
void x86_isa_sahf_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_move, x86_dep_eax, 0, 0, 0, x86_dep_zps,
                x86_dep_cf, x86_dep_of);
}
...
void x86_isa_shld_rm16_r16_imm8_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_shift, x86_dep_rm16, x86_dep_r16, 0,
...
void x86_isa_shld_rm32_r32_imm8_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_shift, x86_dep_rm32, x86_dep_r32, 0,
...
void x86_isa_xadd_rm8_r8_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_add, x86_dep_rm8, x86_dep_r8, 0, x86_dep_aux,
                x86_dep_zps, x86_dep_cf, x86_dep_of);
...
void x86_isa_xadd_rm32_r32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_add, x86_dep_rm32, x86_dep_r32, 0, x86_dep_aux,
                x86_dep_zps, x86_dep_cf, x86_dep_of);
...
void x86_isa_xchg_ir16_ax_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_move, x86_dep_ir16, x86_dep_eax, 0, x86_dep_ir16,
                x86_dep_eax, 0, 0);
}
...
void x86_isa_xchg_ir32_eax_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_move, x86_dep_ir32, x86_dep_eax, 0, x86_dep_ir32,
                x86_dep_eax, 0, 0);
}
...
void x86_isa_xchg_rm8_r8_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_move, x86_dep_rm8, x86_dep_r8, 0, x86_dep_rm8,
                x86_dep_r8, 0, 0);
}
...
void x86_isa_xchg_rm16_r16_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_move, x86_dep_rm16, x86_dep_r16, 0, x86_dep_rm16,
                x86_dep_r16, 0, 0);
}
...
void x86_isa_xchg_rm32_r32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_move, x86_dep_rm32, x86_dep_r32, 0, x86_dep_rm32,
                x86_dep_r32, 0, 0);
}
