...
void x86_isa_addss_xmm_xmmm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_xmm_fp_add, x86_dep_xmmm32, x86_dep_xmm, 0,
                x86_dep_xmm, 0, 0, 0);
}
...
void x86_isa_cmppd_xmm_xmmm128_imm8_impl(X86Context *ctx) {
  ...
  if (!spec_mode) {
    switch (imm8) {
      case 0:
        X86_ISA_CMPP_ASM("cmpeqpd");
        break;
      case 1:
        X86_ISA_CMPP_ASM("cmpltpd");
        break;
      case 2:
        X86_ISA_CMPP_ASM("cmplepd");
        break;
      case 3:
        X86_ISA_CMPP_ASM("cmpunordpd");
        break;
      case 4:
        X86_ISA_CMPP_ASM("cmpneqpd");
        break;
      case 5:
        X86_ISA_CMPP_ASM("cmpnltpd");
        break;
      case 6:
        X86_ISA_CMPP_ASM("cmpnlepd");
        break;
      case 7:
        X86_ISA_CMPP_ASM("cmpordpd");
        break;
      default:
        X86ContextError(ctx, "%s: invalid value for 'imm8'", __FUNCTION__);
    }
  }
...
void x86_isa_cmpps_xmm_xmmm128_imm8_impl(X86Context *ctx) {
  ...
  if (!spec_mode) {
    switch (imm8) {
      case 0:
        X86_ISA_CMPP_ASM("cmpeqps");
        break;
      case 1:
        X86_ISA_CMPP_ASM("cmpltps");
        break;
      case 2:
        X86_ISA_CMPP_ASM("cmpleps");
        break;
      case 3:
        X86_ISA_CMPP_ASM("cmpunordps");
        break;
      case 4:
        X86_ISA_CMPP_ASM("cmpneqps");
        break;
      case 5:
        X86_ISA_CMPP_ASM("cmpnltps");
        break;
      case 6:
        X86_ISA_CMPP_ASM("cmpnleps");
        break;
      case 7:
        X86_ISA_CMPP_ASM("cmpordps");
        break;
      default:
        X86ContextError(ctx, "%s: invalid value for 'imm8'", __FUNCTION__);
    }
...
void x86_isa_cvttss2si_r32_xmmm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_xmm_conv, x86_dep_xmmm32, 0, 0, x86_dep_r32, 0,
                0, 0);
}
...
void x86_isa_divss_xmm_xmmm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_xmm_fp_div, x86_dep_xmmm32, x86_dep_xmm, 0,
                x86_dep_xmm, 0, 0, 0);
}
...
void x86_isa_maxss_xmm_xmmm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_xmm_fp_comp, x86_dep_xmmm32, x86_dep_xmm, 0,
                x86_dep_xmm, 0, 0, 0);
}
...
void x86_isa_movss_xmm_xmmm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_xmm_move, x86_dep_xmmm32, 0, 0, x86_dep_xmm, 0,
                0, 0);
}
...
void x86_isa_movss_xmmm32_xmm_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_xmm_move, x86_dep_xmm, 0, 0, x86_dep_xmmm32, 0,
                0, 0);
}
...
void x86_isa_mulss_xmm_xmmm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_xmm_fp_mult, x86_dep_xmmm32, x86_dep_xmm, 0,
                x86_dep_xmm, 0, 0, 0);
}
...
void x86_isa_pinsrw_xmm_r32m16_imm8_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_xmm_shift, x86_dep_xmm, x86_dep_rm32, 0,
                x86_dep_xmm, 0, 0, 0);
}
...
void x86_isa_sqrtss_xmm_xmmm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_xmm_fp_sqrt, x86_dep_xmmm32, x86_dep_xmm, 0,
                x86_dep_xmm, 0, 0, 0);
}
...
void x86_isa_subss_xmm_xmmm32_impl(X86Context *ctx) {
  ...
  x86_uinst_new(ctx, x86_uinst_xmm_fp_sub, x86_dep_xmmm32, x86_dep_xmm, 0,
                x86_dep_xmm, 0, 0, 0);
}
