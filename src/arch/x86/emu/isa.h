...
void X86ContextMemWrite(X86Context *ctx, unsigned int addr, int size,
                        void *buf);
...
void X86ContextStoreReg(X86Context *ctx, enum x86_inst_reg_t reg,
                        unsigned int value);
...
#define X86ContextLoadR8(ctx) \
  X86ContextLoadReg(ctx, ctx->inst.reg + x86_inst_reg_al)
#define X86ContextLoadR16(ctx) \
  X86ContextLoadReg(ctx, ctx->inst.reg + x86_inst_reg_ax)
#define X86ContextLoadR32(ctx) \
  X86ContextLoadReg(ctx, ctx->inst.reg + x86_inst_reg_eax)
#define X86ContextLoadSReg(ctx) \
  X86ContextLoadReg(ctx, ctx->inst.reg + x86_inst_reg_es)
#define X86ContextStoreR8(ctx, value) \
  X86ContextStoreReg(ctx, ctx->inst.reg + x86_inst_reg_al, value)
#define X86ContextStoreR16(ctx, value) \
  X86ContextStoreReg(ctx, ctx->inst.reg + x86_inst_reg_ax, value)
#define X86ContextStoreR32(ctx, value) \
  X86ContextStoreReg(ctx, ctx->inst.reg + x86_inst_reg_eax, value)
#define X86ContextStoreSReg(ctx, value) \
  X86ContextStoreReg(ctx, ctx->inst.reg + x86_inst_reg_es, value)

#define X86ContextLoadIR8(ctx) \
  X86ContextLoadReg(ctx, ctx->inst.opindex + x86_inst_reg_al)
#define X86ContextLoadIR16(ctx) \
  X86ContextLoadReg(ctx, ctx->inst.opindex + x86_inst_reg_ax)
#define X86ContextLoadIR32(ctx) \
  X86ContextLoadReg(ctx, ctx->inst.opindex + x86_inst_reg_eax)
#define X86ContextStoreIR8(ctx, value) \
  X86ContextStoreReg(ctx, ctx->inst.opindex + x86_inst_reg_al, value)
#define X86ContextStoreIR16(ctx, value) \
  X86ContextStoreReg(ctx, ctx->inst.opindex + x86_inst_reg_ax, value)
#define X86ContextStoreIR32(ctx, value) \
  X86ContextStoreReg(ctx, ctx->inst.opindex + x86_inst_reg_eax, value)
...
#define X86ContextDebugCall(...) \
  debug(x86_context_call_debug_category, __VA_ARGS__)
#define X86ContextDebugISA(...) \
  debug(x86_context_isa_debug_category, __VA_ARGS__)
