...
void arm_thumb32_disasm_init() {
  ...
  arm_thumb32_asm_lv1_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_lv2_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_lv3_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_lv4_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_lv5_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_lv6_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_lv7_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_lv8_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_lv9_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_lv10_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_lv11_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_lv12_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_lv13_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_lv14_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_lv15_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));

  arm_thumb32_asm_ldst_mul_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_ldst_mul1_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_ldst_mul2_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_ldst_mul3_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_ldst_mul4_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_ldst_mul5_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_ldst_mul6_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));

  arm_thumb32_asm_ldst_dual_table =
      xcalloc(32, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_ldst1_dual_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_ldst2_dual_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_asm_ldst3_dual_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));

  arm_thumb32_dproc_shft_reg_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_shft_reg1_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_shft_reg2_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_shft_reg3_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_shft_reg4_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_shft_reg5_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_shft_reg6_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));

  arm_thumb32_dproc_imm_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_imm1_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_imm2_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_imm3_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_imm4_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_imm5_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_imm6_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));

  arm_thumb32_dproc_reg_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_reg1_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_reg2_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_reg3_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_reg4_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_reg5_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_reg6_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_reg7_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));

  arm_thumb32_dproc_misc_table =
      xcalloc(8, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_misc1_table =
      xcalloc(8, sizeof(struct arm_thumb32_inst_info_t));

  arm_thumb32_dproc_bin_imm_table =
      xcalloc(32, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_bin_imm1_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_bin_imm2_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_dproc_bin_imm3_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));

  arm_thumb32_brnch_ctrl_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_brnch_ctrl1_table =
      xcalloc(8, sizeof(struct arm_thumb32_inst_info_t));

  arm_thumb32_st_single_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_st_single1_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_st_single2_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_st_single3_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_st_single4_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_st_single5_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_st_single6_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));

  arm_thumb32_ld_byte_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_ld_byte1_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_ld_byte2_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_ld_byte3_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_ld_byte4_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_ld_byte5_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_ld_byte6_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));

  arm_thumb32_ld_hfword_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_ld_hfword1_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_ld_hfword2_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));

  arm_thumb32_ld_word_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
  arm_thumb32_ld_word1_table =
      xcalloc(16, sizeof(struct arm_thumb32_inst_info_t));
...
#define DEFINST(_name, _fmt_str, _cat, _op1, _op2, _op3, _op4, _op5, _op6, \
                _op7, _op8)                                                \
  arm_thumb32_setup_table(#_name, _fmt_str, ARM_THUMB32_CAT_##_cat, _op1,  \
                          _op2, _op3, _op4, _op5, _op6, _op7, _op8,        \
...
void arm_thumb32_setup_table(char *name, char *fmt_str,
                             enum arm_thumb32_cat_enum cat32, int op1, int op2,
                             int op3, int op4, int op5, int op6, int op7,
                             int op8, enum arm_thumb32_inst_enum inst_name) {
  struct arm_thumb32_inst_info_t *current_table;
  /* We initially start with the first table arm_asm_table, with the opcode
   * field as argument */
...
void arm_thumb16_disasm_init() {
  ...
  arm_thumb16_shft_ins_table =
      xcalloc(16, sizeof(struct arm_thumb16_inst_info_t));
  arm_thumb16_shft_ins_lv2_table =
      xcalloc(16, sizeof(struct arm_thumb16_inst_info_t));

  arm_thumb16_asm_lv1_table =
      xcalloc(4, sizeof(struct arm_thumb16_inst_info_t));
  arm_thumb16_asm_lv2_table =
      xcalloc(4, sizeof(struct arm_thumb16_inst_info_t));
  arm_thumb16_asm_lv3_table =
      xcalloc(4, sizeof(struct arm_thumb16_inst_info_t));
  arm_thumb16_asm_lv4_table =
      xcalloc(4, sizeof(struct arm_thumb16_inst_info_t));
  arm_thumb16_asm_lv5_table =
      xcalloc(4, sizeof(struct arm_thumb16_inst_info_t));
  arm_thumb16_asm_lv6_table =
      xcalloc(4, sizeof(struct arm_thumb16_inst_info_t));
  arm_thumb16_asm_lv7_table =
      xcalloc(64, sizeof(struct arm_thumb16_inst_info_t));
  arm_thumb16_asm_lv8_table =
      xcalloc(4, sizeof(struct arm_thumb16_inst_info_t));
  arm_thumb16_asm_lv9_table =
      xcalloc(64, sizeof(struct arm_thumb16_inst_info_t));

  arm_thumb16_data_proc_table =
      xcalloc(32, sizeof(struct arm_thumb16_inst_info_t));
  arm_thumb16_spcl_data_brex_table =
      xcalloc(32, sizeof(struct arm_thumb16_inst_info_t));
  arm_thumb16_spcl_data_brex_lv1_table =
      xcalloc(4, sizeof(struct arm_thumb16_inst_info_t));

  arm_thumb16_ld_st_table = xcalloc(64, sizeof(struct arm_thumb16_inst_info_t));
  arm_thumb16_ld_st_lv1_table =
      xcalloc(64, sizeof(struct arm_thumb16_inst_info_t));
  arm_thumb16_ld_st_lv2_table =
      xcalloc(64, sizeof(struct arm_thumb16_inst_info_t));
  ...
  arm_thumb16_spcl_data_brex_table[0].next_table =
      arm_thumb16_spcl_data_brex_lv1_table;
  ...
  arm_thumb16_asm_lv7_table[1].next_table =
      arm_thumb16_asm_lv9_table;  // entries [0 to 0xe] of lv9 are inst B //
  arm_thumb16_asm_lv7_table[1].next_table_high = 11;
  arm_thumb16_asm_lv7_table[1].next_table_low = 8;

#define DEFINST(_name, _fmt_str, _cat, _op1, _op2, _op3, _op4, _op5, _op6) \
  arm_thumb16_setup_table(#_name, _fmt_str, ARM_THUMB16_CAT_##_cat, _op1,  \
                          _op2, _op3, _op4, _op5, _op6,                    \
...
void arm_thumb16_setup_table(char *name, char *fmt_str,
                             enum arm_thumb16_cat_enum cat16, int op1, int op2,
                             int op3, int op4, int op5, int op6,
                             enum arm_thumb16_inst_enum inst_name) {
...
void arm_thumb16_inst_dump(FILE *f, char *str, int inst_str_size,
                           void *inst_ptr, unsigned int inst_index,
  ...
  for (byte_index = 0; byte_index < 2; ++byte_index)
    inst.dword.bytes[byte_index] = *(unsigned char *)(inst_ptr + byte_index);
...
void arm_thumb16_inst_dump_RD(char **inst_str_ptr, int *inst_str_size,
  ...
  if (cat == ARM_THUMB16_CAT_MOVSHIFT_REG)
    ...
    rd = ((inst->dword.high_oprs_ins.h1 << 3) |
          inst->dword.high_oprs_ins.reg_rd);
...
void arm_thumb32_inst_dump(FILE *f, char *str, int inst_str_size,
                           void *inst_ptr, unsigned int inst_index,
                           unsigned int inst_addr) {
  ...
  for (byte_index = 0; byte_index < 4; ++byte_index)
    inst.dword.bytes[byte_index] =
        *(unsigned char *)(inst_ptr + ((byte_index + 2) % 4));
...
void arm_thumb32_inst_dump_S(char **inst_str_ptr, int *inst_str_size,
  ...
  if (cat == ARM_THUMB32_CAT_LD_ST_MULT)
    ...
    fatal("%d: sign fmt not recognized", cat);
  if (sign) str_printf(inst_str_ptr, inst_str_size, "s");
}
  ...
  if (inst->dword.ldstr_imm.add)
    ...
    if (add) {
      if (idx == 1 && wback == 0)
        ...
        str_printf(inst_str_ptr, inst_str_size, "[#%d]!",
                   (immd12 & 0x000000ff));
...
void arm_thumb32_inst_dump_IMMD8(char **inst_str_ptr, int *inst_str_size,
  ...
  if (immd8) {
    if (inst->dword.ld_st_double.add_sub) {
      if (inst->dword.ld_st_double.index == 1 &&
          inst->dword.ld_st_double.wback == 0)
        str_printf(inst_str_ptr, inst_str_size, "#%d", (immd8));
      else if (inst->dword.ld_st_double.index == 1 &&
               inst->dword.ld_st_double.wback == 1)
        str_printf(inst_str_ptr, inst_str_size, "#%d!", (immd8));
      else if (inst->dword.ld_st_double.index == 0 &&
               inst->dword.ld_st_double.wback == 0)
        str_printf(inst_str_ptr, inst_str_size, "#%d", (immd8));
    } else {
      if (inst->dword.ld_st_double.index == 1 &&
...
void arm_thumb32_inst_dump_ADDR(char **inst_str_ptr, int *inst_str_size,
  ...
  if (cat == ARM_THUMB32_CAT_BRANCH) {
    ...
    addr = (inst->dword.branch.sign << 20) | (((inst->dword.branch.j2)) << 19) |
           (((inst->dword.branch.j1)) << 18) |
           (inst->dword.branch.immd6 << 12) | (inst->dword.branch.immd11 << 1);
    addr = SEXT32(addr, 21);
  } else
...
void arm_thumb32_inst_decode(struct arm_thumb32_inst_t *inst) {
  struct arm_thumb32_inst_info_t *current_table;
  /* We initially start with the first table mips_asm_table, with the opcode
   * field as argument */
  current_table = arm_thumb32_asm_table;
  ...
  thumb32_table_arg = BITS32(*(unsigned int *)inst->dword.bytes,
                             current_table_high, current_table_low);
...
void arm_thumb16_inst_decode(struct arm_thumb16_inst_t *inst) {
  ...
  thumb16_table_arg = BITS16(*(unsigned short *)inst->dword.bytes,
                             current_table_high, current_table_low);
