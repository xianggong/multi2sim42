...
/* Disassembly Mode */
enum arm_disassembly_mode_t { ARM_DISASM = 1, THUMB_DISASM };
...
enum arm_psr_regs_t { CPSR = 0, SPSR };
...
#define DEFINST(_name, _fmt_str, _category, _arg1, _arg2) ARM_INST_##_name,
#include "asm.dat"
#undef DEFINST
...
// void thumb16_disasm(void *buf, unsigned int ip, volatile struct
// arm_thumb16_inst_t *inst);
// void thumb32_disasm(void *buf, unsigned int ip, volatile struct
// arm_thumb32_inst_t *inst);
