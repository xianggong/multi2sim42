...
int ARMEmuListMember(ARMEmu *emu, enum arm_emu_list_kind_t list,
                     struct arm_ctx_t *ctx);
void ARMEmuListRemove(ARMEmu *emu, enum arm_emu_list_kind_t list,
                      struct arm_ctx_t *ctx);
void ARMEmuListInsertTail(ARMEmu *emu, enum arm_emu_list_kind_t list,
                          struct arm_ctx_t *ctx);
void ARMEmuListInsertHead(ARMEmu *emu, enum arm_emu_list_kind_t list,
                          struct arm_ctx_t *ctx);
