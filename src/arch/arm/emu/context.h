...
enum arm_thumb_iteq_t { ITEQ_DISABLED = 0, ITEQ_ENABLED };

enum arm_mode_t { ARM = 1, THUMB };

enum arm_inst_mode_t { ARM32 = 1, THUMB16, THUMB32 };
...
struct arm_ctx_t {
  ...
  unsigned int
      inst_type; /* The type of the current instruction ARM/Thumb16/Thumb32 */
  ...
  /* When debugging function calls with 'arm_isa_debug_call', function call
   * level. */
  int function_level;
